...
def main():
    ...
    poses = {
        '1': [800, 800, 800, 800, 800, 100],  # 1. Open
        '2': [50, 50, 50, 50, 700, 1000],                    # 2. Closed
        '3': [50, 50, 50, 50, 300, 1000],              # 3. Pinch
        '4': [1000, 1000, 1000, 1000, 1000, 1000],         # 4. Entirely Open
        '5': [800, 800, 800, 800, 300, 300],        # 5. Half Grasp
        '6': [1000, 1000, 1000, 1000, 1000, 1000],         # 6. Grab Smooth On
        '7': [300, 300, 300, 300, 1000, 100],        # 7. Grab
    }

    print("------------------------------------------------")
    print("Interactive Inspire Hand Control")
    print("Press 1-7 to send command.")
    print("Press 'q' to quit.")
    print("------------------------------------------------")

    while True:
        # This blocks the code until you type and hit enter
        user_input = input("Enter Pose (1-7): ").strip().lower()
        ...
        if user_input in poses:
            ...
            print("Invalid selection. Try 1-7.")
